...
public class FIAR extends FIARMsg {
	 ...
	 * @param x
	 * @param y
	 * @return a coded int: <br>
	 * 			VALID - valid move, game continues <br>
	 * 			WINNING_MOVE - valid move, player wins<br>
	 * 			INVALID - invalid move
	 * 			ERROR - error (may want to be more specific here)
	 */
	public int makePlay(int player, int x, int y){
